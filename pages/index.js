  ...
  return (
    <div>
      ...
      <div className="flex justify-center mt-16 ">
        ...
        <ChevronRightIcon className="h-8 cursor-pointer bg-gray-400 rounded-md ml-3 self-center mt-16" onClick={() => people >= data.length - 1 ? setPeople(people - 3) : setPeople(people + 1)}/>
      </div>
    </div>
  );
}
